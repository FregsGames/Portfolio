...
{
    /// <summary>
    /// This class saves data in a file and have methods to read and write it
    /// It works similary to Unity's playerPrefbs but saving data in a file
    /// allows me to store stuff on Steam cloud, for example
    /// </summary>
    ...
    public ResolutionManager rMaanger;
    public ProgressController pController;
    ...
    {
        //Ints
        /*writer = new StreamWriter(Application.persistentDataPath + intFile, false);
